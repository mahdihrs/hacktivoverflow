    ...
    <div>
        <nav id="navHome" class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item active">
                    <router-link style="font-family: 'Playfair Display', serif;" class="nav-link" to="/login"><strong>Login</strong></router-link>
                </li>
                <li class="nav-item active">
                    <router-link style="font-family: 'Playfair Display', serif;" class="nav-link" to="/register"><strong>Register</strong></router-link>
                </li>
                </ul>
